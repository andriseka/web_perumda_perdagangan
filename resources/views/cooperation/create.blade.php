...
@section('content')
    <div class="mb-4">
        <h3 class="fw-bolder">BUAT KERJASAMA</h3>
    </div>

    <form action="{{ url('/admin/cooperation/store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Tulis Nama Kerjasama" required >
                            @error('title')
