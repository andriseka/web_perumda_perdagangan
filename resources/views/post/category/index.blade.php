    ...
    <div class="row">
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="card-body">
                    <div>
                        <h4 class="fw-bolder">Buat Kategori</h4>
                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                @if ($category['slug'] !== 'uncategorized')
                                                    ...
                                                    <form action="{{ url('/admin/post/category/delete', $category['slug']) }}" method="POST">
                                                        @csrf
                                                        @method('delete')
                                    ...
                                    <div class="modal fade" id="{{ $category['slug'] }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-sm modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ url('/admin/post/category/update', $category['slug']) }}" method="POST">
                                                    @csrf
                                                    @method('patch')
